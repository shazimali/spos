...
@section('content')
    ...
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title">Purchase Record  &nbsp; &nbsp;<a  href="{{url('purchase-create')}}" class="btn btn-success "><i class="fa fa-plus"></i></a></h3>
            <hr>
                ...
                <table id="example23" class="display nowrap table table-hover table-striped" cellspacing="0" width="100%">
                    ...
                    @foreach($purchases as $purchase)
                        ...
                        <tr>
                            ...
                            <td>{{$purchase->date}}</td>
                            <td>
                                <a href="{{url('purchase/'.$purchase->id.'/edit')}}" class="btn btn-primary " ><span class="glyphicon glyphicon-edit"></span> </a>
{{--                                <a target="_blank" href="{{url('purchase/'.$purchase->id.'/show')}}" class="btn btn-default" ><span class="glyphicon glyphicon-print"></span> </a>--}}
