...
<div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title ">Expense List &nbsp; &nbsp;  <a  href="{{url('expense/create')}}" class="btn btn-success "><i class="fa fa-plus"></i></a> </h3>
                <hr>
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td>{{$i}}</td>
                            <td>{{$exp->expensHead->title}}</td>
                            <td>{{$exp->amount}}</td>
                            <td>{{$exp->date}}</td>
                            <td>
                            <a href="{{url('expense/edit/'.$exp->id)}}" class="btn btn-primary " ><span class="glyphicon glyphicon-edit"></span> </a>
                        </td>
                            </tr>
