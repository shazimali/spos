...
@section('title', 'Return Sales Record')
...
@section('content')
    ...
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">Return Sales Record  &nbsp; &nbsp;
                <a  href="{{url('sales-return')}}" class=" btn btn-primary"><i class="fa fa-plus"></i> </a></h3>
            <hr>
            <div class="table-responsive">
                <table id="example23" class="display nowrap table table-hover table-striped" cellspacing="0" width="100%">
                    ...
                    @foreach($sales as $sale)
                        ...
                        <tr>
                            <td>{{$sn++}}</td>
                            <td><a href="javascript:" onclick="window.open('{{route('sale-inovice-print',$sale->id)}}','_blank' ,  'fullscreen=yes');">rs#{{$sale->id}}</a></td>
                            ...
                            <td>{{$sale->time}}</td>
                            <td>
                                <a href="{{url('sales-return/'.$sale->id.'/edit')}}" class="btn btn-primary " ><span class="glyphicon glyphicon-edit"></span> </a>
