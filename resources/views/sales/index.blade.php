...
@section('content')
    ...
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title m-b-0">Sales Record &nbsp; &nbsp;
                <a  href="{{url('sales-create')}}" class=" btn btn-primary "><i class="fa fa-plus"></i></a>
            </h3>
            <hr>
                ...
                <table id="example23" class="display nowrap table table-hover table-striped" cellspacing="0" width="100%">
                    ...
                    @foreach($sales as $sale)
                        ...
                        <td><a href="javascript:" onclick="window.open('{{route('sale-inovice-print',$sale->id)}}','_blank' ,  'fullscreen=yes');">sl#{{$sale->id}}</a></td>
                            ...
                            <td>{{$sale->date}}</td>
                            <td>
                                <a href="{{url('sales/'.$sale->id.'/edit')}}" class="btn btn-primary " ><span class="glyphicon glyphicon-edit"></span> </a>
