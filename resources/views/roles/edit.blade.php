    ...
    <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <br/>
                <form id="roleForm" class="form-horizontal" method="post" action="{{url('/role/update/'.$role->id)}}">
                            @csrf
                            @method('PUT')
                        <div class="form-group">
                            <label class="col-md-12">Title</label>
                            <div class="col-md-12">
                            <input id="title" type="text" value="{{$role->name}}" class="form-control" name="name"> </div>
                        </div>
                        ...
                        <div id="permissionsBlock" class="form-group">
                                ...
                                @foreach($permissions as $pr)
                                            ...
                                            <input class="chk" name="{{$pr->id}}" @if(in_array( $pr->id, $role->permissions->pluck(['id'])->toArray())) checked @endif  type="checkbox">
                        ...
                        <div class="form-group">
                            <input id="btn_create" type="submit" class="btn btn-primary pull-right" value="Update">
                        </div>
                    </form>
                </div>
            </div>
